...
const PlantCard2 = ({plant}) => {
    ...
    return (
        <div>
            <div
       className="cursor-pointer card bg-base-100 hover:scale-102 transition ease-in-out shadow-sm ">
        ...
        <div className="card-body">
          ...
          <div className="card-actions flex mt-2 justify-between items-center">
